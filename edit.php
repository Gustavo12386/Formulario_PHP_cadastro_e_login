...
<body>
<a href="sistema.php" class="btn btn-light me-5 btn-lg">Voltar</a>
    <div class="box">
      <form action="saveEdit.php" method="POST">
         <fieldset>
            ...
            <div class="inputBox">
              ...
              <input type="date" name="data_nascimento" id="data_nascimento" class="InputUser"  value="<?php echo $data_nasc ?>">              
            </div>
            <br><br>
            <div class="inputBox">
